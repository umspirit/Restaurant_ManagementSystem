...
public class LastMission13 extends JFrame {
	...
	public LastMission13() throws FileNotFoundException {	
	...
	class Reservation extends JDialog {
		...
		class CenterPanel extends JPanel {
			public CenterPanel() {
				...
				namefield.setText(Stringtxt[0]);			// 텍스트 파일에서 읽은 String을 JTextField에 저장시켜준다.	
				birthfield.setText(Stringtxt[1]);			// 텍스트 파일에서 읽은 String을 JTextField에 저장시켜준다.
				hpfield1.setText(Stringtxt[2]);				// 텍스트 파일에서 읽은 String을 JTextField에 저장시켜준다.
				hpfield2.setText(Stringtxt[3]);				// 텍스트 파일에서 읽은 String을 JTextField에 저장시켜준다.
				hpfield3.setText(Stringtxt[4]);				// 텍스트 파일에서 읽은 String을 JTextField에 저장시켜준다.
