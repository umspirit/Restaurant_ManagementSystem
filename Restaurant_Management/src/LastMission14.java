...
public class LastMission14 extends JFrame {
	...
	public LastMission14() throws FileNotFoundException {	
		super("JUNG KII & COOK");								// 미션 13 레코드 단위로 텍스트 읽기
		...
		sale.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				int result = JOptionPane.showConfirmDialog(null, "정산을 합니다",
	...
	class Survey extends JDialog{					// 미션 14 
	...
	class SteakPanel extends JDialog {     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
		SteakPanel() {
			setTitle("STEAK");
			getContentPane();
			setLayout(null);
	...
	class PastaPanel extends JDialog {     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
		PastaPanel() {
			setTitle("PASTA");
			getContentPane();
			setLayout(null);
	...
	class PilafPanel extends JDialog {     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
		PilafPanel() {
			setTitle("PILAF");
			getContentPane();
			setLayout(null);
	...
	class PizzaPanel extends JDialog {     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
		PizzaPanel() {
			setTitle("PIZZA");
			getContentPane();
			setLayout(null);
	...
	class SidePanel extends JDialog {     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
		SidePanel() {
			setTitle("SIDE MENU");
			getContentPane();
			setLayout(null);
	...
	class DrinkPanel extends JDialog {     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
		DrinkPanel() {
			setTitle("BEVERAGE");
			getContentPane();
			setLayout(null);
	...
	class FoodMenu extends JDialog {		     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
	...
	class Click0 extends JDialog {		     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
	...
	class Event extends JDialog {		     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
		Event(){
			setTitle("페인트 사용");
			getContentPane();
			setModal(true);
	...
	class Reservation extends JDialog {		     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
		...
		/*		if (e.getSource() == ok) {
				...
				if (e.getSource() == mainbox) {
					int result = JOptionPane.showConfirmDialog(null, "고르시겠습니까 ?","", JOptionPane.YES_NO_OPTION);
					if(result == JOptionPane.YES_OPTION){
				...
				if (e.getSource() == ok && tablebox.getSelectedItem().equals(" 1번  ")) {
					if (tbtn[0].getBackground() == Color.YELLOW) {
						JOptionPane.showMessageDialog(null, "이미 예약된 자리입니다.", "", JOptionPane.ERROR_MESSAGE);
					...
					if (tbtn[1].getBackground() == Color.YELLOW) {
						JOptionPane.showMessageDialog(null, "이미 예약된 자리입니다.", "Message", JOptionPane.ERROR_MESSAGE);
						ok.setBackground(Color.WHITE);
						cancel.setVisible(true);
					} else {
	...
	class MyThird extends JDialog {		     //미션 14 대화상자를 호출하고 대화상자에서 호출한 값을 메인 윈도우에 반영
		MyThird() {
			setTitle("단골손님 사진");
			setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
			setSize(300, 400);
